...
![1584195719645](https://smartan123.github.io/book/library/images/1584195719645.png)
...
![1584196385034](D:\Program Files\typora-user-images\1584196385034.png)



这个startstop线程实际代码调用就是采用的JDK自带线程池来做的，启动位置就是ContainerBase的组件父类的startInternal()：

![1584196048806](D:\Program Files\typora-user-images\1584196048806.png)
...
![1584196714178](D:\Program Files\typora-user-images\1584196714178.png)

顾名思义，该线程是用于异步文件处理的，它的作用是在Tomcat级别构架出一个输出框架，然后不同的日志系统都可以对接这个框架，因为日志对于服务器来说，是非常重要的功能。

如下，就是juli的配置：

![1584196877893](D:\Program Files\typora-user-images\1584196877893.png)
...
![1584200549363](D:\Program Files\typora-user-images\1584200549363.png)



我们可以看到这个代码，也就是在ContainerBase中：

![1584200704730](D:\Program Files\typora-user-images\1584200704730.png)
...
![1584201033048](D:\Program Files\typora-user-images\1584201033048.png)

![1584201068001](D:\Program Files\typora-user-images\1584201068001.png)
...
![1584238520638](D:\Program Files\typora-user-images\1584238520638.png)

如果不配置，Acceptor线程默认开始就开启1个，后期再随着压力增大而增长：

![1584238658710](D:\Program Files\typora-user-images\1584238658710.png)
...
![1584238019629](D:\Program Files\typora-user-images\1584238019629.png)

对于Poller线程实际就是继续接着Acceptor进行处理，展开Selector，然后遍历key，将后续的任务转交给工作线程（exec线程），起到的是一个缓冲，转接，和NIO事件遍历的作用，具体代码体现如下（NioEndpoint类）：

![1584238272139](D:\Program Files\typora-user-images\1584238272139.png)
...
![1584239277914](D:\Program Files\typora-user-images\1584239277914.png)



![1584239091296](D:\Program Files\typora-user-images\1584239091296.png)

该线程的重要性不言而喻，Tomcat主要的时间都耗在这个线程上，所以我们可以看到Tomcat里面有很多的优化，配置，都是基于这个线程的，尽可能让这个线程减少阻塞，减少线程切换，甚至少创建，多利用。

下面就是NIO模式下创建的工作线程：

![1584239579371](D:\Program Files\typora-user-images\1584239579371.png)
...
![1584242888071](D:\Program Files\typora-user-images\1584242888071.png)
...
![1584243575318](D:\Program Files\typora-user-images\1584243575318.png)
...
![1584243290669](D:\Program Files\typora-user-images\1584243290669.png)
